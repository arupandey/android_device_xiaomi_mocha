...
# Kernel
BOARD_KERNEL_CMDLINE := "androidboot.selinux=permissive" BOARD_KERNEL_BASE := 0x10000000
BOARD_KERNEL_PAGESIZE := 2048

TARGET_USERIMAGES_USE_EXT4 := true
BOARD_BOOTIMAGE_PARTITION_SIZE := 20971520 # 20M BOARD_RECOVERYIMAGE_PARTITION_SIZE := 20971520 # 22M BOARD_SYSTEMIMAGE_PARTITION_SIZE := 671088640 # 619M #BOARD_USERDATAIMAGE_PARTITION_SIZE := 13742637056 # 13G BOARD_CACHEIMAGE_PARTITION_SIZE := 402653184 # 390M BOARD_CACHEIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_FLASH_BLOCK_SIZE := 131072 # (BOARD_KERNEL_PAGESIZE * 64)

TARGET_PREBUILT_KERNEL := device/xiaomi/mocha/kernel BOARD_MKBOOTIMG_ARGS := --ramdisk_offset 0x02000000 --dt device/xiaomi/mocha/dt.img --tags_offset 0x00000100 BOARD_KERNEL_SEPARATED_DT := true
...
#BOARD_USE_CUSTOM_RECOVERY_FONT := \"roboto_23x41.h\" TARGET_RECOVERY_LCD_BACKLIGHT_PATH := \"/sys/class/backlight/lcd-backlight/brightness\" COMMON_GLOBAL_CFLAGS += -DNO_SECURE_DISCARD BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/xiaomi/mocha/recovery/recovery_keys.c TARGET_RECOVERY_FSTAB := device/xiaomi/mocha/twrp.fstab RECOVERY_SDCARD_ON_DATA := true
RECOVERY_GRAPHICS_USE_LINELENGTH := true
TW_INCLUDE_CRYPTO := true
TW_INCLUDE_L_CRYPTO := true
TW_INTERNAL_STORAGE_PATH := "/data/media" TW_INTERNAL_STORAGE_MOUNT_POINT := "data"
TW_EXTERNAL_STORAGE_PATH := "/sdcard"
TW_EXTERNAL_STORAGE_MOUNT_POINT := "sdcard"
TW_THEME := portrait_hdpi
#RECOVERY_TOUCHSCREEN_FLIP_Y := true
#RECOVERY_TOUCHSCREEN_FLIP_X := true
TARGET_PREBUILT_RECOVERY_KERNEL := device/xiaomi/mocha/kernel BOARD_MKRECOVERYIMG_ARGS := --dt device/xiaomi/mocha/dt.img PRODUCT_COPY_FILES += device/xiaomi/mocha/twrp.fstab:recovery/root/etc/twrp.fstab

#	device/xiaomi/mocha/recovery.fstab:recovery/root/etc/recovery.fstab # device/xiaomi/mocha/rootdir/sbin/e2fsck_static:recovery/root/sbin/e2fsck_static
...
# SELinux
BOARD_SEPOLICY_DIRS += device/xiaomi/mocha/sepolicy BOARD_SEPOLICY_UNION += \
te_macros \
app.te \
bluetooth.te \
bootanim.te \
